...
app.use(session({
    secret: 'rcbootcamper2019d', // session secret
    resave: true,
...
//   db.collection('volunteer').save({name: req.body.name, msg: req.body.msg, thumbUp: 0, thumbDown:0}, (err, result) => {
//     if (err) return console.log(err)
...
//   db.collection('volunteer').findOneAndDelete({name: req.body.name, msg: req.body.msg}, (err, result) => {
